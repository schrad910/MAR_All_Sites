...
=======
before<-subset_samples(phylo, Timing == "Before")
>>>>>>> d25a30465319aa7897ece058f2f747ca9ee59c1b
...
=======
#summary(eigenvals(model)) #constrained explains 23.9% of variance
#RsquareAdj(model) #adjusted is 15.8%
>>>>>>> d25a30465319aa7897ece058f2f747ca9ee59c1b
...
=======
            mapping = aes(label = Label, x = CCA1*1.1, y = CCA2*1.15) ) +
  geom_point(data = subset(f_model, Score=="sites" & CCA2<5),
             mapping= aes(x=CCA1, y=CCA2, col= Location, shape= Location))+
  coord_fixed()+
  scale_color_manual(values = palette)+ 
  ...
  geom_abline(intercept = 0,slope = 0,linetype="dashed", size=0.8)+ 
  geom_vline(aes(xintercept=0), linetype="dashed", size=0.8)+ 
  labs(x="CCA1 (10.8%)", y="CCA2 (8.6%)" , caption = "ANOVA(Location)<.001")+
>>>>>>> d25a30465319aa7897ece058f2f747ca9ee59c1b
  theme_pubr(legend = "right")
ggsave(here("Figures/before_cca.svg"))
